...
girl_image = Image.open("Image/girl.png")
grandma_image = Image.open("Image/grandma.png")
step_image = Image.open("Image/step.png")
wolf_image = Image.open("Image/wolf.png")
